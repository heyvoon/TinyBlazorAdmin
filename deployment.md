...
To add a custom domain to your AzUrlShortener & TinyBlazorAdmin, [follow these steps](https://github.com/heyvoon/AzUrlShortener/blob/main/doc/post-deployment-configuration.md from the the AzUrlShortener repo.
